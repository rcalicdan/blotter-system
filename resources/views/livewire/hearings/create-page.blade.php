<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Schedule Hearing</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-zinc-400">Schedule a new hearing for a dispute.</p>
        </div>
    ...
    <form wire:submit="save">
        <x-form.card title="Hearing Details" description="Fill in the details for this hearing.">
            ...
            <x-slot:footer>
                <div class="flex items-center justify-end gap-3">
                    ...
                    <x-ui.button type="submit" wire:loading.attr="disabled" wire:loading.class="opacity-75">
                        <span wire:loading.remove>Schedule Hearing</span>
