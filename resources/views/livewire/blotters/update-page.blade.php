<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-zinc-400">Update entry {{ $blotterEntry->blotter_number }}.
            </p>
        </div>
    ...
    <form wire:submit="save">
        <x-form.card title="Incident Information" description="Update the details of the incident.">
