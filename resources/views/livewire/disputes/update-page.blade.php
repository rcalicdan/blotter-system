<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Dispute</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-zinc-400">Update dispute {{ $dispute->case_number }}.</p>
        </div>
    ...
    <form wire:submit="save">
        <x-form.card title="Dispute Information" description="Update the details of the dispute.">
