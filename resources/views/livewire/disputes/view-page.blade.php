                ...
                @if ($dispute->hearings->isNotEmpty())
                    <div class="space-y-4">
                        @foreach ($dispute->hearings as $hearing)
                            <div
                                class="group flex items-center justify-between p-4 bg-white dark:bg-zinc-900 rounded-xl border border-gray-100 dark:border-zinc-800 hover:border-red-200 dark:hover:border-red-900/30 transition-all shadow-sm">
                                <div class="flex items-center gap-4">
                                    <div @class([
                                        ...
                                        <span
                                            class="text-lg leading-none">{{ $hearing->scheduled_date->format('d') }}</span>
                                    </div>
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2 mt-0.5">
                                            ...
                                            <span
                                                class="text-xs text-gray-500 dark:text-zinc-400">{{ $hearing->location }}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="relative">
                                ...
                                <div @class([
                                    ...
                                    'bg-blue-500 text-white' =>
                                        $party->role === \App\Enums\DisputePartyRole::Complainant,
                                    'bg-red-500 text-white' =>
                                        $party->role === \App\Enums\DisputePartyRole::Respondent,
                                ])>
                ...
                <div
                    ...
                    <div class="flex items-start justify-between gap-3 mb-4">
                        ...
                        <div class="flex items-center gap-1 flex-shrink-0">
                            {{-- View --}}
                            <a href="{{ route('disputes.resolution.view', $dispute) }}"
                            ...
                            @can('update', $dispute->resolution)
                                <a href="{{ route('disputes.resolution.edit', $dispute) }}"
                                    class="p-1.5 rounded-lg bg-white/10 hover:bg-white/20 transition-colors"
                            ...
                            @can('delete', $dispute->resolution)
                                <button type="button" wire:click="deleteResolution"
                                    wire:confirm="Are you sure you want to delete this resolution? This cannot be undone."
                                    class="p-1.5 rounded-lg bg-white/10 hover:bg-red-500/60 transition-colors"
                    ...
                    <div class="space-y-4">
                        <div>
                            <p class="text-[10px] uppercase font-bold text-emerald-100 tracking-wider">Settlement Type
                            </p>
